...
for i = 1 : Part(1,4)
    for j = 1: Part(1,3)
        if(imagen(i,j) == 1)
           ...
           imgFace(Part(1,2)+i,Part(1,1)+j,1) = eyeColorSetting(1)*value;
            imgFace(Part(1,2)+i,Part(1,1)+j,2) = eyeColorSetting(2)*value;
             imgFace(Part(1,2)+i,Part(1,1)+j,3) = eyeColorSetting(3)*value;
        end 
    end
end

...
S.ctrl_expression_bar = uicontrol('style', 'slide',...
 ...
 S.ctrl_hair_chosen = uicontrol('FontSize', 12,...
                              'FontName', '¸¼Àº °íµñ',...
                                'string', '¼±ÅÃ', ...
                                'FontWeight', 'bold',...
...
%% Color Lense
 ...
 S.ctrl_lense_chosen = uicontrol('FontSize', 12,...
                                  'FontName', '¸¼Àº °íµñ',...
                                     'string', '¼±ÅÃ', ...
                                     'FontWeight', 'bold',...
...
S.cheek= uicontrol('Style', 'radiobutton',...
                   'FontWeight', 'bold',...
                 'FontName', '¸¼Àº °íµñ',...
                  'String','º¼ÅÍÄ¡',...
                  'Position',[600 164 50 40],...
